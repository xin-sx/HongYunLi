...
object LunarCalendar {
    ...
    private val ganZhiYears = arrayOf(
    ...
    fun solarToLunar(year: Int, month: Int, day: Int): LunarDate {
        ...
        val offset = ((targetDate.timeInMillis - baseDate.timeInMillis) / 86400000).toInt()
        
        var lunarYear = 1900
        var daysInYear = 0
        var tempOffset = offset
        
        while (lunarYear < 2100 && tempOffset > 0) {
        ...
        val ganZhiIndex = (lunarYear - 4) % 60
        ...
        while (lunarMonth <= 12 && tempOffset > 0) {
        ...
        return LunarDate(
            ganZhiYear = ganZhiYears[ganZhiIndex],
            lunarMonthName = lunarMonths[lunarMonth - 1],
            lunarDayName = lunarDays[lunarDay - 1],
            zodiac = zodiacs[zodiacIndex],
            monthChinese = lunarMonths[lunarMonth - 1],
            dayChinese = lunarDays[lunarDay - 1]
        )
    }
